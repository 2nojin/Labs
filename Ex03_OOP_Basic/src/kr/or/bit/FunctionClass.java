 ...
 * **함수가 return Type(ex public int calc(){ return 100; }을 가지고 있다면
...
public class FunctionClass {
	...
	public int max2(int a, int b) { // 삼항연산자 활용
		return (a > b) ? a : b;
		// int max = (a>b) ? a : b;
	}
	...
	public Tv objMethod() { // Tv 타입을 갖는 주소값을 return
		Tv tt = new Tv(); // heap메모리에 객체 만들고 주소값 tt에 할당
		tt.brandname = "중저가";
		return tt;
	}

	public Tv objMethod2() {
		return new Tv(); // heap메모리에 객체 만들고 주소값 return
	}
