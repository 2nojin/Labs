 ...
 * 1.1 private : 직접할당을 막고 간접할당을 통해서 자원을 보호 
 * 1.2 설계자의 의도(원하는 값만 처리) age 변수에 1~200 정수만 허용 > 별도의 함수를 통해 구현
 * 1.3 캡슐화된 자원의 간접할당을 처리하는 특수한 함수 (setter, getter)
 *     private member field에 read, write 할 수 있는 함수
 *     
 * 1.4 private int age;
 * 	   -setter (0) 함수
 * 	   -getter (0) 함수
 * 	   -필요에 따라서는 setter만 구현, getter 구현해되 된다.
 * 
 * 
 */
public class Car {
