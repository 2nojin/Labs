...
public class Ex01_Ref_Type {
	...
	public static void main(String[] args) {
		Person person;	//STACK 영역에 4Byte 빈 공간(person타입) null
		
		person = new Person();	//HEAP 메모리에 Person 객체 만들고 pesron 변수에 주소값을 할당
		...
		int num=100;	//main함수 안에 있는 local variable(반드시초기화)
		...
		you = person;	//person과 you의 동거가 시작
		System.out.println("you : " +you);
		System.out.println("person : " +person);
		System.out.println(you == person);	//==값비교 (같은주소 : true)
		
		Tv t = new Tv();
		t.brandname="삼성";
		
		System.out.println("기본채널 : " +t.ch);	//0
		System.out.println("브랜드명 : " +t.brandname);	//String null
		
		
		System.out.println("전원정보 : " +t.power);
		t.power_on();	//호출한다.(함수는 이름을 불러주었을 때 실행)
		System.out.println("전원정보 : " +t.power);
