...
//AWT (CS프로그램을 만들수 있는 class제공)
//JAVA 라는 언어로 메모장, 계산기 등....(현재 JAVA는 WEB 중심)

//AWT >> SWING(순수 자바 코드로 버전up)

//componen(class 모음) : 버튼, 프레임 등 ... 만들어 놓았어요
...
class BtnClick_Handler implements ActionListener{
	...
	//click 대한 핸들러(함수)
	//버튼을 click 하면 actionPerformed 함수 자동 호출
	@Override
...
public class Ex12_AWT_Frame {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//ActionListner 구현하는 클래스의 객체 생성 >> 재사용 가능(btn, btn2도 사용)
