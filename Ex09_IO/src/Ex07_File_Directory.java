...
public class Ex07_File_Directory {
	public static void main(String[] args) {
		...
		String path = "C:\\Temp\\file.txt";	//file.txt 만들어져 있다는 전제하에..
		
		File f = new File(path);	//번역하면,, 내가 file.txt. 줄테니까 분석좀 해봐
		...
		System.out.println("너 파일이니? : " +f.isFile() +"byte");
