...
//클래스 == 설계도 == 타입
//클래스는 반드시 메모리에 올려야 사용가능 (설계도를 기반으로 땅에 아파트를 지어야)
...
public class Ex05_Ref_Type {
	...
	public static void main(String[] args) {
		...
		//Apt2 타입(사용자 정의 타입 : 여러개의 타입을 모아놓은 큰 타입)
		Apt2 lg = new Apt2();	//lg 변수는 Apt2 객체의 주소값을 갖는다.)
		//lg : 주소값을 가지고 있는 변수 : 참조변수, 객체변수
		
		System.out.println("lg변수의 값은 : 주소 : " +lg);
		
		Apt2 ssapt=lg;	//lg 가지는 주소를 ssapt 전달
		//ssapt와 lg는 같은 집에서 산다.
		//참조변수의 할당은 주소값 할당
		ssapt.window = 50;
		
		System.out.println("창문의 갯수는 : " +lg.window);
